...
package cn.jhd.face.client.seetaface;
...
public class JniClient {
     ...
     * @return
     */
    public String DetectFace(byte[] vImgData, int vColNum, int vRowNum, int vCh, String vDetectModelPath) {
        return DetectFace(vImgData, vColNum, vRowNum, vCh, vDetectModelPath, 20, 2.0f, 0.8f);
    }

    public native String DetectFace(byte[] vImgData, int vColNum, int vRowNum, int vCh, String vDetectModelPath, int minFaceSize, float scoreThresh, float scaleFactor);
