package cn.jhd.face.client.service;
...
import cn.jhd.face.client.ui.MainActivity;
import cn.jhd.face.client.utils.TDevice;
...
public class DownloadService extends Service {
    ...
    private String saveFileName = Constants.DEFAULT_DOWNLOAD_PATH;
    ...
    private Runnable mDownApkRunnable = new Runnable() {
        @Override
        public void run() {
            File file = new File(Constants.DEFAULT_DOWNLOAD_PATH);
            if (!file.exists()) {
                file.mkdirs();
            }
    ...
    public long downloadUpdateFile(String downloadUrl, File saveFile)
        ...
        try {
            ...
            httpConnection
                    .setRequestProperty("UserBean-Agent", "PacificHttpClient");
            if (currentSize > 0) {
