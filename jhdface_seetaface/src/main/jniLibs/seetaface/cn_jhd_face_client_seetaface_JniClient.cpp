/**
 * 采用中科院山世光开源的cn_jhd_face_client_seetafaceEngine实现android上的人脸检测与对齐、识别
 * BSD license
 */

#include "cn_jhd_face_client_seetaface_JniClient.h"
#include "CMImgProc.h"
 ...
 */
JNIEXPORT void JNICALL Java_cn_jhd_face_client_seetaface_JniClient_CMimGamma(JNIEnv
...
彩色转灰度图
 */
JNIEXPORT void JNICALL Java_cn_jhd_face_client_seetaface_JniClient_CMim2gray(JNIEnv
 ...
 */
JNIEXPORT jfloat JNICALL Java_cn_jhd_face_client_seetaface_JniClient_CMCalcFaceSim
 ...
 *检测人脸，获取人脸范围及5个点的坐标
 */
JNIEXPORT jstring JNICALL Java_cn_jhd_face_client_seetaface_JniClient_DetectFace
(JNIEnv *env, jobject obj, jbyteArray v_img_data,
		jint cols, jint rows, jint ch, jstring vFaceModelPath,jint minFaceSize, jfloat scoreThresh, jfloat scaleFactor)
{
...
//	detector.SetWindowStep(4, 4);
	...
	ImageData img_gray;
	img_gray.data = (unsigned char*)tImgData;
	img_gray.width = cols;
	...
	if(0 == num_face ){
		...
		env->ReleaseByteArrayElements(v_img_data,tImgData,0);
		env->ReleaseStringUTFChars(vFaceModelPath, tFaceModelPath);
 ...
 *检测人脸，获取人脸范围及5个点的坐标
 */
JNIEXPORT jstring JNICALL Java_cn_jhd_face_client_seetaface_JniClient_CMDetectFace
(JNIEnv *env, jobject obj, jbyteArray v_img_data,
 ...
 *剪切出人脸
 */
JNIEXPORT jbyteArray JNICALL Java_cn_jhd_face_client_seetaface_JniClient_CMCropFace
(JNIEnv *env, jobject obj, jbyteArray v_img_data,
...
JNIEXPORT jstring JNICALL Java_cn_jhd_face_client_seetaface_JniClient_CMimread(JNIEnv *env, jobject obj, jstring impath)
{
	const char* tPath;
